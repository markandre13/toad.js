...
/*!***************************!*\
  !*** ./src/controller.ts ***!
  \***************************/
/*! exports provided: Controller, Template, globalController, bind, action, unbind, text, boolean */function(t,e,o){"use strict";o.r(e),o.d(e,"Controller",function(){return l}),o.d(e,"Template",function(){return d}),o.d(e,"globalController",function(){return a}),o.d(e,"bind",function(){return c}),o.d(e,"action",function(){return h}),o.d(e,"unbind",function(){return u}),o.d(e,"text",function(){return f}),o.d(e,"boolean",function(){return p});var i=o(/*! ./dom */"./src/dom.ts"),n=o(/*! ./model */"./src/model.ts"),s=o(/*! ./action */"./src/action.ts"),r=o(/*! ./signal */"./src/signal.ts");class l{constructor(){this.modelId2Models=new Map,this.modelId2Views=new Map,this.view2ModelIds=new Map,this.sigChanged=new r.Signal}registerAction(t,e){let o=new s.Action(void 0,t);return o.signal.add(e),this._registerModel("A:"+t,o),o}registerModel(t,e){this._registerModel("M:"+t,e)}_registerModel(t,e){let o=this.modelId2Models.get(t);o||(o=new Set,this.modelId2Models.set(t,o)),o.add(e);let i=this.modelId2Views.get(t);if(i)for(let t of i)t.setModel(e)}registerView(t,e){if(e.controller&&e.controller!==this)return void console.log("error: attempt to register view more than once at different controllers");e.controller=this;let o=this.view2ModelIds.get(e);o||(o=new Set,this.view2ModelIds.set(e,o)),o.add(t);let i=this.modelId2Views.get(t);i||(i=new Set,this.modelId2Views.set(t,i)),i.add(e);let n=this.modelId2Models.get(t);if(n)for(let t of n)e.setModel(t)}unregisterView(t){if(!t.controller)return;if(t.controller!==this)throw Error("attempt to unregister view from wrong controller");let e=this.view2ModelIds.get(t);if(e)for(let o of e){let e=this.modelId2Views.get(o);e&&(e.delete(t),0===e.size&&this.modelId2Views.delete(o),t.setModel(void 0))}}clear(){for(let t of this.view2ModelIds)t[0].setModel(void 0);this.modelId2Models.clear(),this.modelId2Views.clear(),this.view2ModelIds.clear()}bind(t,e){this.registerModel(t,e)}action(t,e){return this.registerAction(t,e)}text(t,e){let o=new n.TextModel(e);return this.bind(t,o),o}html(t,e){let o=new n.HtmlModel(e);return this.bind(t,o),o}boolean(t,e){let o=new n.BooleanModel(e);return this.bind(t,o),o}number(t,e,o){let i=new n.NumberModel(e,o);return this.bind(t,i),i}}class d extends l{constructor(t){super(),this.root=i.instantiateTemplate(t);let e=this.root.querySelectorAll("[model]");for(let t of e){let e=t;if(e)try{this.registerView(e.getModelId(),e)}catch(t){}}e=this.root.querySelectorAll("[action]");for(let t of e){let e=t;if(e)try{this.registerView(e.getActionId(),e)}catch(t){}}}}let a=new l;function c(t,e){a.bind(t,e)}function h(t,e){return a.registerAction(t,e)}function u(){a.clear()}function f(t,e){return a.text(t,e)}function p(t,e){return a.boolean(t,e)}},"./src/dom.ts":
/*!********************!*\
  !*** ./src/dom.ts ***!
  \********************/
