...
/*!***********************!*\
  !*** ./src/action.ts ***!
  \***********************/
/*! no static exports found */function(t,e,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0});const o=i(/*! ./model */"./src/model.ts"),n=i(/*! ./signal */"./src/signal.ts");class s extends o.Model{constructor(t,e){super(),this.signal=new n.Signal,this.title=e,this._enabled=!0}set value(t){throw Error("Action.value can not be assigned a value")}get value(){throw Error("Action.value can not return a value")}set enabled(t){this._enabled!=t&&(this._enabled=t,this.modified.trigger())}get enabled(){return this._enabled}trigger(t){this._enabled&&this.signal.trigger(t)}}e.Action=s},"./src/controller.ts":
/*!***************************!*\
  !*** ./src/controller.ts ***!
  \***************************/
