...
/*!***********************!*\
  !*** ./src/signal.ts ***!
  \***********************/
/*! exports provided: SignalLink, Signal */function(t,e,i){"use strict";i.r(e),i.d(e,"SignalLink",function(){return o}),i.d(e,"Signal",function(){return n});class o{constructor(t,e){this.callback=t,this.id=e}}class n{add(t,e){this.callbacks||(this.callbacks=new Array),this.callbacks.push(new o(t,e))}remove(t){if(this.callbacks)for(let e=this.callbacks.length-1;e>=0;--e)this.callbacks[e].id===t&&this.callbacks.splice(e,1)}count(){return this.callbacks?this.callbacks.length:0}trigger(){if(this.callbacks)for(let t=0;t<this.callbacks.length;++t)this.callbacks[t].callback()}}},"./src/toad.ts":
/*!*********************!*\
  !*** ./src/toad.ts ***!
  \*********************/
