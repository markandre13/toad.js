...
/*!***************************!*\
  !*** ./src/controller.ts ***!
  \***************************/
/*! exports provided: Controller, Template, globalController, bind, action, unbind */function(t,e,o){"use strict";o.r(e),o.d(e,"Controller",function(){return l}),o.d(e,"Template",function(){return d}),o.d(e,"globalController",function(){return a}),o.d(e,"bind",function(){return c}),o.d(e,"action",function(){return h}),o.d(e,"unbind",function(){return u});var i=o(/*! ./dom */"./src/dom.ts"),n=o(/*! ./model */"./src/model.ts"),s=o(/*! ./action */"./src/action.ts"),r=o(/*! ./signal */"./src/signal.ts");class l{constructor(){this.modelId2Models=new Map,this.modelId2Views=new Map,this.view2ModelIds=new Map,this.sigChanged=new r.Signal}registerAction(t,e){let o=new s.Action(void 0,t);return o.signal.add(e),this._registerModel("A:"+t,o),o}registerModel(t,e){this._registerModel("M:"+t,e)}_registerModel(t,e){let o=this.modelId2Models.get(t);o||(o=new Set,this.modelId2Models.set(t,o)),o.add(e);let i=this.modelId2Views.get(t);if(i)for(let t of i)t.setModel(e)}registerView(t,e){if(e.controller&&e.controller!==this)return void console.log("error: attempt to register view more than once at different controllers");e.controller=this;let o=this.view2ModelIds.get(e);o||(o=new Set,this.view2ModelIds.set(e,o)),o.add(t);let i=this.modelId2Views.get(t);i||(i=new Set,this.modelId2Views.set(t,i)),i.add(e);let n=this.modelId2Models.get(t);if(n)for(let t of n)e.setModel(t)}unregisterView(t){if(!t.controller)return;if(t.controller!==this)throw Error("attempt to unregister view from wrong controller");let e=this.view2ModelIds.get(t);if(e)for(let o of e){let e=this.modelId2Views.get(o);e&&(e.delete(t),0===e.size&&this.modelId2Views.delete(o),t.setModel(void 0))}}clear(){for(let t of this.view2ModelIds)t[0].setModel(void 0);this.modelId2Models.clear(),this.modelId2Views.clear(),this.view2ModelIds.clear()}bind(t,e){this.registerModel(t,e)}action(t,e){return this.registerAction(t,e)}text(t,e){let o=new n.TextModel(e);return this.bind(t,o),o}html(t,e){let o=new n.HtmlModel(e);return this.bind(t,o),o}boolean(t,e){let o=new n.BooleanModel(e);return this.bind(t,o),o}number(t,e,o){let i=new n.NumberModel(e,o);return this.bind(t,i),i}}class d extends l{constructor(t){super(),this.root=i.instantiateTemplate(t);let e=this.root.querySelectorAll("[model]");for(let t of e){let e=t;e&&this.registerView(e.getModelId(),e)}e=this.root.querySelectorAll("[action]");for(let t of e){let e=t;e&&this.registerView(e.getModelId(),e)}}}let a=new l;function c(t,e){a.bind(t,e)}function h(t,e){return a.registerAction(t,e)}function u(){a.clear()}},"./src/dom.ts":
/*!********************!*\
  !*** ./src/dom.ts ***!
  \********************/
/*! exports provided: instantiateTemplate, tmpl, find, tag, txt, img, add, remove, erase, grabMouse, attribute, attributeOrUndefined, order */function(t,e,o){"use strict";function i(t){return n(t)}function n(t){let e=document.querySelector('template[id="'+t+'"]');if(!e)throw new Error("failed to find template '"+t+"'");let o=e.content;return document.importNode(o,!0)}function s(t,e){return t.querySelector(e)}function r(t){return document.createElement(t)}function l(t){return document.createTextNode(t)}function d(t){let e=document.createElement("img");return e.src=t,e}function a(t,e){t.appendChild(e)}function c(t){if(!t.parentNode)throw Error("element has no parent");t.parentNode.removeChild(t)}function h(t){for(;t.firstChild;)t.removeChild(t.firstChild)}function u(t){}function f(t,e){let o=t.getAttribute(e);if(null===o)throw console.log("missing attribute '"+e+"' in ",t),Error("missing attribute '"+e+"' in "+t.nodeName);return o}function p(t,e){let o=t.getAttribute(e);return null===o?void 0:o}function w(t,e){let o,i=new Map,n=t;for(o=t;n=o,o=o.parentNode;)i.set(o,n);let s=e;for(o=e;o;){if(s=o,!(o=o.parentNode))throw Error("fuck");let t=i.get(o);if(t){n=t;break}o=o.parentNode}if(!o)throw Error("fuck");for(let t of o.childNodes){if(t===n)return!0;if(t===s)return!1}throw Error("fuck")}o.r(e),o.d(e,"instantiateTemplate",function(){return i}),o.d(e,"tmpl",function(){return n}),o.d(e,"find",function(){return s}),o.d(e,"tag",function(){return r}),o.d(e,"txt",function(){return l}),o.d(e,"img",function(){return d}),o.d(e,"add",function(){return a}),o.d(e,"remove",function(){return c}),o.d(e,"erase",function(){return h}),o.d(e,"grabMouse",function(){return u}),o.d(e,"attribute",function(){return f}),o.d(e,"attributeOrUndefined",function(){return p}),o.d(e,"order",function(){return w})},"./src/model.ts":
/*!**********************!*\
  !*** ./src/model.ts ***!
  \**********************/
...
/*!*********************!*\
  !*** ./src/toad.ts ***!
  \*********************/
/*! exports provided: Signal, Action, Model, GenericModel, TextModel, HtmlModel, NumberModel, BooleanModel, RadioStateModel, View, GenericView, SlotView, ButtonView, CheckboxView, MenuButton, SliderView, TableView, TableModel, TableEditMode, SelectionModel, registerTableModelLocator, createTableModel, TextView, Controller, Template, bind, action, unbind, globalController, Window, RadioButtonBase, FatRadioButton */function(t,e,o){"use strict";o.r(e),o.d(e,"Window",function(){return w}),o.d(e,"RadioButtonBase",function(){return m}),o.d(e,"FatRadioButton",function(){return g});var i=o(/*! ./dom */"./src/dom.ts"),n=o(/*! ./signal */"./src/signal.ts"),s=o(/*! ./view */"./src/view.ts");o.d(e,"Signal",function(){return n.Signal});var r=o(/*! ./action */"./src/action.ts");o.d(e,"Action",function(){return r.Action});var l=o(/*! ./model */"./src/model.ts");o.d(e,"Model",function(){return l.Model}),o.d(e,"GenericModel",function(){return l.GenericModel}),o.d(e,"TextModel",function(){return l.TextModel}),o.d(e,"HtmlModel",function(){return l.HtmlModel}),o.d(e,"NumberModel",function(){return l.NumberModel}),o.d(e,"BooleanModel",function(){return l.BooleanModel}),o.d(e,"RadioStateModel",function(){return l.RadioStateModel}),o.d(e,"View",function(){return s.View}),o.d(e,"GenericView",function(){return s.GenericView}),o.d(e,"SlotView",function(){return s.SlotView});var d=o(/*! ./view/button */"./src/view/button.ts");o.d(e,"ButtonView",function(){return d.ButtonView});var a=o(/*! ./view/checkbox */"./src/view/checkbox.ts");o.d(e,"CheckboxView",function(){return a.CheckboxView});var c=o(/*! ./view/menu */"./src/view/menu.ts");o.d(e,"MenuButton",function(){return c.MenuButton});var h=o(/*! ./view/slider */"./src/view/slider.ts");o.d(e,"SliderView",function(){return h.SliderView});var u=o(/*! ./view/table */"./src/view/table.ts");o.d(e,"TableView",function(){return u.TableView}),o.d(e,"TableModel",function(){return u.TableModel}),o.d(e,"TableEditMode",function(){return u.TableEditMode}),o.d(e,"SelectionModel",function(){return u.SelectionModel}),o.d(e,"registerTableModelLocator",function(){return u.registerTableModelLocator}),o.d(e,"createTableModel",function(){return u.createTableModel});var f=o(/*! ./view/text */"./src/view/text.ts");o.d(e,"TextView",function(){return f.TextView});var p=o(/*! ./controller */"./src/controller.ts");o.d(e,"Controller",function(){return p.Controller}),o.d(e,"Template",function(){return p.Template}),o.d(e,"bind",function(){return p.bind}),o.d(e,"action",function(){return p.action}),o.d(e,"unbind",function(){return p.unbind}),o.d(e,"globalController",function(){return p.globalController});customElements.define("toad-if",class extends s.GenericView{updateModel(){}updateView(){this.model&&(this.style.display=this.model.value?"":"none")}});class w{constructor(t,e){t instanceof w?(this.window=void 0,this.parent=t):(this.window=t,this.parent=void 0),this.title=e}}class m extends w{constructor(t,e){super(t,e),this.clicked=new n.Signal}}class g extends m{constructor(t,e,o,n){super(t,e);let s=this;this.model=o,this.value=n,s.window=i.tag("div"),s.window.classList.add("fatradiobutton"),o.hasValue()||o.setValue(n),o.getValue()==n&&s.window.classList.add("fatradiobutton-selected"),s.window.onmousedown=function(t){return s.model.setValue(n),!1},o.modified.add(function(){if(!s.window)throw Error("fuck");s.model.getValue()==n?s.window.classList.add("fatradiobutton-selected"):s.window.classList.remove("fatradiobutton-selected")});let r=i.img("img/"+e+".svg");i.add(s.window,r),i.add(t.window,s.window)}}},"./src/view.ts":
/*!*********************!*\
  !*** ./src/view.ts ***!
  \*********************/
/*! exports provided: View, GenericView, ActionView, SlotView */function(t,e,o){"use strict";o.r(e),o.d(e,"View",function(){return r}),o.d(e,"GenericView",function(){return l}),o.d(e,"ActionView",function(){return d}),o.d(e,"SlotView",function(){return a});var i=o(/*! ./model */"./src/model.ts"),n=o(/*! ./controller */"./src/controller.ts"),s=o(/*! ./action */"./src/action.ts");class r extends HTMLElement{getModelId(){if(!this.hasAttribute("model"))throw Error("no 'model' attribute");let t=this.getAttribute("model");if(!t)throw Error("no model id");return"M:"+t}}class l extends r{constructor(){super()}connectedCallback(){if(this.controller)return;let t="";try{t=this.getModelId()}catch(t){}""!=t&&n.globalController.registerView(t,this)}disconnectedCallback(){this.controller&&this.controller.unregisterView(this)}setModel(t){if(t===this.model)return;let e=this;this.model&&this.model.modified.remove(e),t&&t.modified.add(()=>{e.updateView()},e),this.model=t,this.updateView()}}class d extends l{constructor(){super()}connectedCallback(){if(!this.controller){try{n.globalController.registerView(this.getActionId(),this)}catch(t){}try{n.globalController.registerView(this.getModelId(),this)}catch(t){}this.updateView()}}disconnectedCallback(){super.disconnectedCallback(),this.controller&&this.controller.unregisterView(this)}getActionId(){if(!this.hasAttribute("action"))throw Error("no 'action' attribute");let t=this.getAttribute("action");if(!t)throw Error("no action id");return"A:"+t}setModel(t){if(!t)return this.model&&this.model.modified.remove(this),this.action&&this.action.modified.remove(this),this.model=void 0,this.action=void 0,void this.updateView();if(t instanceof s.Action)this.action=t,this.action.modified.add(()=>{this.updateView()},this);else{if(!(t instanceof i.TextModel))throw Error("unexpected model of type "+t.constructor.name);this.model=t,this.model.modified.add(()=>{this.updateView()},this)}this.updateView()}isEnabled(){return void 0!==this.action&&this.action.enabled}}class a extends l{constructor(){super()}updateModel(){}updateView(){if(!this.model)return;let t=void 0===this.model.value?"":this.model.value;this.model instanceof i.HtmlModel?this.innerHTML=t:this.innerText=t}}window.customElements.define("toad-slot",a)},"./src/view/button.ts":
/*!****************************!*\
  !*** ./src/view/button.ts ***!
  \****************************/
/*! exports provided: ButtonView */function(t,e,o){"use strict";o.r(e),o.d(e,"ButtonView",function(){return r});var i=o(/*! ../model */"./src/model.ts"),n=o(/*! ../view */"./src/view.ts");let s=document.createElement("style");s.textContent="\n  button {\n    border: none;\n    background-color: #0052cc;\n    color: #ffffff;\n    border-radius: 3px;\n    font-size: 14px;\n    font-weight: bold;\n    height: 32px;\n    line-height: 32px;\n    min-width: 24px;\n    text-shadow: none;\n    padding: 0 10px;\n    margin-right: 4px;\n  }\n  \n  button:hover {\n    background-color: #0065ff;\n  }\n  \n  button:hover:active {\n    background-color: #0049b0;\n  }\n  \n  button:disabled, button:disabled:active {\n    background-color: #888;\n  }\n";class r extends n.ActionView{constructor(){super();if(this.button=document.createElement("button"),this.button.onclick=(()=>{this.action&&this.action.trigger()}),this.button.disabled=!0,this.attachShadow({mode:"open"}),!this.shadowRoot)throw Error("fuck");this.shadowRoot.appendChild(document.importNode(s,!0)),this.shadowRoot.appendChild(this.button)}updateModel(){}updateView(){this.model&&this.model.value?this.model instanceof i.HtmlModel?this.button.innerHTML=this.model.value:this.button.innerText=this.model.value:this.button.innerHTML=this.innerHTML,this.button.disabled=!this.isEnabled()}}window.customElements.define("toad-button",r)},"./src/view/checkbox.ts":
/*!******************************!*\
