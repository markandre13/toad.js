...
describe("toad.js", function() {
    describe("ModelView<M> is a View with a model", function() {
        it("updateView() is called when the model is modified, added or removed", function() {
    ...
    it("when the model emits a message ModelView<Model<MSG>>, then updateView(msg?: MSG) will receive it", function() {
        interface MyMessage {
            message: string
        }
