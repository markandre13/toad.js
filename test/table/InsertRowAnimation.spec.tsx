    ...
    describe("row", function () {
        ...
        describe("remove", function () {
            it("two rows at head", async function () {
                ...
                const y0 = 0
                const y1 = border + 48
                const y2 = border + 48 + border + 72
                const y3 = border + 48 + border + 72 + border + 32
                const initialHeight = border + 48 + border + 72 + border + 32 + border + 64 + border
                const removeHeight = border + 48 + border + 72
                // the mask will hide the rows to be removed, hence it is placed directly below them
                const maskY0 = y2 + border // TODO: would this also work without the border?
                const maskH0 = removeHeight + border // TODO: do we really need need the '+ border'?
            ...
            it("two rows at middle", async function () {
                ...
                const y0 = 0
                const y1 = border + 32
                const y2 = border + 32 + border + 48
                const y3 = border + 32 + border + 48 + border + 72
                const initialHeight = border + 32 + border + 48 + border + 72 + border + 64 + border
                const removeHeight = border + 48 + border + 72
                // the mask will hide the rows to be removed, hence it is placed directly below them
                const maskY0 = y3 + border // TODO: would this also work without the border?
                const maskH0 = removeHeight + border // TODO: do we really need need the '+ border'?
                // the split body has a border on top and bottom
                const splitY0 = y3
            ...
            it("two rows at end", async function () {
                ...
                const y0 = 0
                const y1 = border + 32
                const y2 = border + 32 + border + 64
                const y3 = border + 32 + border + 64 + border + 48
                const initialHeight = border + 32 + border + 48 + border + 72 + border + 64 + border
                const removeHeight = border + 48 + border + 72
                // the mask will hide the rows to be removed, hence it is placed directly below them
